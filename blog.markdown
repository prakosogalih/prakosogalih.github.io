...
<div class="container py-5">
  ...
  <div class="mb-5 pb-4 border-bottom-2" style="border-bottom: 2px solid #f0f0f0; padding-bottom: 2rem;">
    <h1 class="display-4 fw-bold mb-3">Blog Automation Engineering</h1>
    <p class="lead text-muted mb-0">Jelajahi koleksi lengkap artikel saya tentang automation, RPA, DevOps, dan best practices. Setiap artikel dirancang untuk memberikan insights praktis dan actionable.</p>
  </div>

  <!-- Filter Section -->
  <div class="mb-5">
    <div class="d-flex align-items-center gap-3 mb-4">
      {% assign blog_posts = site.posts | where_exp: "post", "post.lang != 'en'" %}
      <span class="text-muted small fw-bold">📊 Jumlah Artikel: <strong>{{ blog_posts.size }}</strong></span>
    </div>
  </div>
  ...
  {% if blog_posts.size == 0 %}
    <div class="text-center py-5">
      ...
      <p class="text-muted">Artikel akan muncul di sini. Kembali lagi nanti!</p>
    </div>
  {% endif %}
</div>
